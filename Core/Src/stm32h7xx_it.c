...
void EXTI1_IRQHandler(void)
{
  ...
  (PIN_GNSS1_TIMEPULSE_N_GPIO_Port->IDR & PIN_GNSS1_TIMEPULSE_N_Pin) ? (PIN_PPS_OUT_GPIO_Port->BSRR = PIN_PPS_OUT_Pin)
							: (PIN_PPS_OUT_GPIO_Port->BSRR = (uint32_t)PIN_PPS_OUT_Pin << 16);
